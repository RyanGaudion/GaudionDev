---
title: How to setup Google Analytics 4 with GDPR compliant cookie consent in NextJS 13
date: '22 Mar 2023 17:11'
description: How to setup Google Analytics (GA4) Consent Mode inside a NextJS 13 application (using the new App Router) with TypeScript. Consent mode will ask the user for consent before storing cookies in the browser.
