...
Another community meetup is also expected in Stockholm too within the next month or 2 - potentially to announce further EU expansion.

### New Content

Finally, there is expected to be a regular release of content:

- **Tech Blogs** - Shahid understood the value of the previous Freetrade tech blogs and want to bring this back, starting with a blog about the new Billing System
- **Podcast?** - Adam & Viktor currently host an weekly internal podcast for employees to listen to company updates. The co-founder pair want to expand this format externally soon - not sure on what this format would look like?
