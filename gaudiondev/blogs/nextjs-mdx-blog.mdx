...
Using this approach, we can override existing default components too with custom versions of those components, such as our [custom link mdx component](/blogs/mdx-link-component). Or add additional funcitonality such as [embedding YouTube Videos in our MDX Blog](/blogs/mdx-youtube-embed).
...
### Related Blogs
 ...
 - [Custom Link - MDX Component](/blogs/mdx-link-component)
