...
- What Import Alias - Leave this as the default
...
Using this approach, we can override existing default components too with custom versions of those components, such as our [custom link mdx component](/blogs/custom-mdx-link-component). Or add additional funcitonality such as [embedding YouTube Videos in our MDX Blog](/blogs/mdx-youtube-embed).

## 7. Rehype & Remark Plugins

To extend MDX further, we can use both [rehype & remark plugins](https://v0.mdxjs.com/advanced/plugins). These plugins allow things such as additional markdown syntax, [code highlighting inside your blog post](/blogs/mdx-syntax-highlighting) or automatic generation of table of contents.
...
### Related Blogs
 ...
 - [What is MDX](/blogs/what-is-mdx)
 - [Google Analytics with Next.js](/blogs/setup-google-analytics-with-gdpr-compliant-cookie-consent-in-nextjs13)
 - [YouTube Video -  MDX Component](/blogs/mdx-youtube-embed)
 - [Custom Link - MDX Component](/blogs/custom-mdx-link-component)
 - [Syntax Highlighting with MDX Blog](/blogs/mdx-syntax-highlighting)