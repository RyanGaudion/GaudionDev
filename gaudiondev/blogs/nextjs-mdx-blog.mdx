...
Using this approach, we can override existing default components too with custom versions of those components, such as our [custom link mdx component](/blog/mdx-link-component). Or add additional funcitonality such as [embedding YouTube Videos in our MDX Blog](/blog/mdx-youtube-embed).

## 7. Rehype & Remark Plugins

To extend MDX further, we can use both [rehype & remark plugins](https://v0.mdxjs.com/advanced/plugins). These plugins allow things such as additional markdown syntax, [code highlighting inside your blog post](/blog/mdx-syntax-highlighting) or automatic generation of table of contents.
